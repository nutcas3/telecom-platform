...
// PublishProfileEvent publishes a profile-related event
func (mq *MessageQueue) PublishProfileEvent(eventType string, profileID string, payload map[string]any) error {
	if mq == nil {
		return nil // Skip if message queue not initialized
	}
